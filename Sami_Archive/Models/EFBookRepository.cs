...
namespace Sami_Archive.Models
{
    public class EFBookRepository : IBookRepository
    {
        ...
        public async Task UpdateBookAsync1(Book book)
        {
        ...
        public async Task UpdateBookAsync(UpdateBooksViewModel viewModel)
        {
            var currentBook = await _context.Books
                .Include(b => b.Genres)
                .Include(b => b.Authors)
            ...
            currentBook.BookTitle = viewModel.BookTitle;
            currentBook.BookDescription = viewModel.BookDescription;
